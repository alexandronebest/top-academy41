...
class Auto:
        ...
        def save_auto(self):
              with open('auto.txt', 'a', encoding='utf-8') as f:
                  f.write(f'Производитель:{self.Manufacturer} Модель:{self.model}, год выпуска:{self.year}, объем двигателя:{self.engine}, цвет:{self.color}, цена: {self.__price}\n')
                   
                   
        def display_info(self):
             print(f'Производитель:{self.Manufacturer} Модель:{self.model}, год выпуска:{self.year}, объем двигателя:{self.engine}, цвет:{self.color}, цена: {self.__price}\n')
...
class Book:
        ...
        def save_book(self):
              with open('book.txt', 'a', encoding='utf-8') as f:
                  f.write(f'Название книги:{self.name}, год выпуска:{self.year}, под издательством:{self.publisher}, жанр:{self.genre}, автор:{self.author}, по цене: {self.__price}\n')
                   
                   
        def display_info(self):
             print(f'Название книги:{self.name}, год выпуска:{self.year}, под издательством:{self.publisher}, жанр:{self.genre}, автор:{self.author}, по цене: {self.__price}\n')
